...
// для превода
   var rus = {
      ...
      mySkills: 'Мои навыки',
      frontEnd: 'Начал изучать React.js.',
      personal: 'Личные качества',
      qualities1: 'Стресоустойчивость', 
      qualities2: 'Ответственност',
      qualities3: 'Умение работать в команде',
      languageMe: 'Знание языков',
      skillsLanguage1: 'Украинский - родной язык',
      skillsLanguage2: 'Русский - второй родной язык',
      skillsLanguage3: 'Английский(изучаю) - beginner 2',
      skillDriver: 'Вождение',
      cardDriver:'Водительское удостоверение(категории):',
   ...
   var eng = {
      ...
      mySkills: 'My skills',
      frontEnd: 'Started learning React.js.',
      personal: 'Personal qualities',
      qualities1: 'Stress resistance',
      qualities2: 'Responsibility',
      qualities3: 'Teamwork skills',
      languageMe: 'Language skills',
      skillsLanguage1: 'Ukrainian is my native language',
      skillsLanguage2: 'Russian is my second native language',
      skillsLanguage3: 'English (learning) - beginner 2',
      skillDriver: 'Driving',
      cardDriver:'Driving license(categories):',
   ...
   var ua = {
      ...
      frontEnd: 'Почав вивчати React.js.',
      personal: 'Особисті якості',
      qualities1: 'Стресостійкість',
      qualities2: 'Відповідальність',
      qualities3: 'Уміння працювати в команді',
      languageMe: 'Знання мов',
      skillsLanguage1: 'Українська – рідна мова',
      skillsLanguage2: 'Російська - друга мова',
      skillsLanguage3: 'Англійська(вивчаю) - beginner 2',
      skillDriver: 'Водіння',
      cardDriver:'Посвідчення водія(категорії):',
